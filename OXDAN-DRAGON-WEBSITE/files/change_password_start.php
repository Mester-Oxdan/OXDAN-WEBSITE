...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="files/css/minified/change_new_password_style.min.css">
    <script src="https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit" async defer></script>
    <script src="files/js/jquery.js"></script>
    <script src="files/js/minified/alert_system_script.min.js"></script>
    <script src="files/js/minified/change_password_2_start_script.min.js"></script>
      ...
      <script type="text/javascript">
        ...
        var onloadCallback = function() {
          widgetId1 = grecaptcha.render('example3', {
            'sitekey' : '6LcdQxUsAAAAAOR5GSjcIa5liqL_lX8pRXWIMrFP',
            'theme' : 'light'
          });
        };
