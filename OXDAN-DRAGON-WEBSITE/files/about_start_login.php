...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="files/css/minified/about_start_login_style.min.css">
    ...
    <body onload="getUsernameFromServer();">
      ...
      <div class="bg-text_large_main">
        <b>!ORIGINAL OXDAN DRAGON WEBSITE!</b>
      </div>
      <div class="bg-text">
        <a style='font-family: Arial, sans-serif;'><b>!REMEMBER!</b> Author don't care and he is not responsible for your deals in this console. This console was created for learning coding and testing security. You</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> can find code of this console on Author github (<a href="https://github.com/Mester-Oxdan" target="_blank">https://github.com/Mester-Oxdan</a>). This console has so many advantages for example 1) so many</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> commands! This console has 9 classes of different command types: MAINS, HACKER_STUFFS, PICTURES, ACCOUNTS, SERIOUS, GAMES, OWNS, PRANKS</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> and ELSES. Author advises testing all these utilities just on your devices. If you find some bugs or errors please let Author know. You can send a message on Author</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> email (bogerter4521de@gmail.com). It will be better if you will take some pictures or videos of the problem. Please don't send some bullshit on the Author email.</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> Because Author respects you and trusts in your help. Author just wants to make this console perfect with your help. If you have ideas it can also be helpful</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> for Author. Author will check email 1 time per week. Also your name could be on the leaders board in the lists section. Difference between OXDAN DRAGON C/C++</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> and OXDAN DRAGON PYTHON is almost the same but Python better because for Author was easier programing on Python than on C/C++, so Python likely have</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> little bit more commands than C/C++. This console was made for Windows! Author still didn't create this console for linux, phones and other systems. Author started</a>
        <a style='font-family: Arial, sans-serif;'><br> </br> creating this console only because of studying coding in 2023, but then it became a project where Author created his first program. Thanks!</a>
        <a style='font-family: Arial, sans-serif;'><b><br>Photos 2025:</b></a>
      </div>
      <div class="bg-text_images_screens">
