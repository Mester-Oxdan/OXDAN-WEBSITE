...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="description" content="Register your account with Oxdan Praduction today! Stay secure, manage your settings, and explore personalized features — fast, safe, and easy.">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>REGISTRATION</title>
    <link id="logo-icon" rel="icon" type="image/png" href="files/resources/images/my_dragon_ico.ico">
    <link rel="stylesheet" type="text/css" href="files/css/minified/registration_style.min.css">
  ...
  <body>
    <div class="container">
      ...
      <form id="register_form">
        ...
        <input type="text" id="username" maxlength="60" required>
        <label for="email">Email:</label>
        <input type="email" id="email" maxlength="60" required>
        <label for="password">Password:</label>
        <input type="password" id="password" maxlength="60" required>
        <label for="showPassword" id="showPasswordLabel" class="show-password"></label>
        <br>
